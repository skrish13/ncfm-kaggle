...
# from ncfm_eval import ncfm_eval
# from utils.yolo import preprocess_train


class NCFMDataset(ImageDataset):
	def __init__(self, imdb_name, datadir, batch_size, im_processor, processes=3, shuffle=True, dst_size=None):
		super(NCFMDataset, self).__init__(imdb_name, datadir, batch_size, im_processor, processes, shuffle, dst_size)

		self._classes = ('ALB','BET','DOL','LAG','NoF','OTHER','SHARK','YFT')
		self._class_to_ind = dict(zip(self.classes, range(self.num_classes)))
		self._image_ext = '.jpg'

		self.basepath = "/home/pdguest/Datasets/NCFM/train/"
