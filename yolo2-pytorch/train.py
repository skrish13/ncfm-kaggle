...
from datasets.ncfm import NCFMDataset
...
# data loader
imdb = NCFMDataset(cfg.imdb_train, cfg.DATA_DIR, cfg.train_batch_size, yolo_utils.preprocess_train, processes=2, shuffle=True, dst_size=cfg.inp_size)
